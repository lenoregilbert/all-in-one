...
|----------------------------------------|-----------------------------------------------------|
| `ghcr.io/lenoregilbert/aio-nextcloud:latest`       | `ghcr.io/lenoregilbert/aio-nextcloud:php{version}-latest`       |
| `ghcr.io/lenoregilbert/aio-nextcloud:latest-arm64` | `ghcr.io/lenoregilbert/aio-nextcloud:php{version}-latest-arm64` |



 - e.g. `ghcr.io/lenoregilbert/aio-nextcloud:php8.0-latest` or `ghcr.io/lenoregilbert/aio-nextcloud:php8.0-latest-arm64`
 - However, if you are unsure check the ghcr.io (https://github.com/lenoregilbert/all-in-one/pkgs/container/aio-nextcloud/versions?filters%5Bversion_type%5D=tagged) and docker hub: https://hub.docker.com/r/nextcloud/aio-nextcloud/tags?name=php
...
In general it should be ```ghcr.io/lenoregilbert/aio-nextcloud:php8.x-latest-arm64``` or `ghcr.io/lenoregilbert/aio-nextcloud:php8.x-latest` replacing `x` with the version you require.
However, if you are unsure check the ghcr.io (https://github.com/lenoregilbert/all-in-one/pkgs/container/aio-nextcloud/versions?filters%5Bversion_type%5D=tagged) and docker hub: https://hub.docker.com/r/nextcloud/aio-nextcloud/tags?name=php
